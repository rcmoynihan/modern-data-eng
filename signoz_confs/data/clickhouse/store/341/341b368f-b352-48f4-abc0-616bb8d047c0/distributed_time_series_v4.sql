ATTACH TABLE _ UUID 'ea1a59d9-2702-4b1e-985b-4cf388237cab'
(
...
ENGINE = Distributed('cluster', 'signoz_metrics', 'time_series_v4', cityHash64(env, temporality, metric_name, fingerprint, unix_milli))
